...
- **Profiles are auto-generated from the Geofabrik index** — `generate_profiles.py` fetches `index-v1-nogeom.json` at runtime and builds the full hierarchy. No hardcoded region lists. A weekly GitHub Action opens a PR when the index changes
